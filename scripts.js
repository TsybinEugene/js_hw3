...
console.log(summa, summa/count2);
...
let numStr = '4 98 4 328 6 1 32 4 65 4 3 5 7 89 7 10 1 36 8 57';
let min, max;
...
console.log('Максимально число в строке: ' + max);
...
for (; k < nStr.length; k++) {
    console.log(nStr[k]);
    summN += +nStr[k];
    nStrRev += nStr[(nStr.length - 1) - k];
}

console.log('Кол-во цифр в числе: ' + k);
console.log('Сумма цифр числа: ' + summN);
console. log('Обратный порядок цифр в числе: ' + nStrRev);